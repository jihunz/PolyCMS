class DragOrder {
    constructor (selector, direction) {
        ...
        root.style["flex-direction"] = direction ? "row" : "column";
        ...
        this.list.forEach(item => {
            ...
            item.addEventListener("drop", e => {
                ...
                console.log(`${sourceOrder} ====>>> ${targetOrder}`);
                this.moveOrder(sourceOrder, targetOrder);
    ...
    moveOrder(source, target) {
        ...
        this.list.forEach( item => {
            ...
            if(source_ < target_) {
                if(order == source_)
                    item.setAttribute("data-order", target);
        ...
        this.list.forEach( item => {
            item.style["order"] = item.getAttribute("data-order");
        });
    }
}